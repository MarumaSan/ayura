        ...
        try {
            ...
            if (res.ok) {
                ...
                if (storedProfile) {
                    ...
                    localStorage.setItem('ayuraProfile', JSON.stringify({ ...parsed, balance: data.balance }));
                    window.dispatchEvent(new Event('auth-change'));
                }
                        ...
                        {!showQR ? (
                            ...
                            <div className="text-center animate-fade-in">
                                ...
                                <p className="text-sm text-gray-500 mb-6 px-4">
                                    กรุณาสแกน QR Code ด้วยแอพพลิเคชั่นธนาคารของคุณ เพื่อเติมเงิน (ระบบทดสอบ: กดปุ่มด้านล่างเพื่อสมมติว่าสแกนโอนเงินแล้ว)
                                </p>
                                <div className="flex gap-3">
                                    <button
                                    ...
                                    <button
                                        ...
                                        disabled={isToppingUp}
                                    >
                                        {isToppingUp ? 'กำลังตรวจสอบ...' : 'จำลองการสแกนจ่าย'}
                                    </button>
                                </div>
                            </div>
                        )}
